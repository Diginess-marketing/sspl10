...
const outputPath = path.join(outputDir, 'Diyansh_Jain.png');
// const playersPath = path.join(__dirname, '../public/Players_Data.json'); // Future proofing
