...
const EXCEL_PATHS = [
    "C:\\Users\\ADMIN\\Downloads\\L1_Selected,_L2_Absent_List (1).xlsx",
    "C:\\Users\\ADMIN\\Downloads\\Selected_L1_&_L2,_Absent_L3_List (1) (1).xlsx"
];
...
async function sendEmails() {
    ...
    for (const EXCEL_PATH of EXCEL_PATHS) {
        console.log(`\n--- Processing file: ${EXCEL_PATH} ---`);
        // 2. Read Excel File
        if (!fs.existsSync(EXCEL_PATH)) {
            console.error(`Excel file not found at ${EXCEL_PATH}. Skipping...`);
            continue;
        }
...
🌐 www.ssplt10.co.in`;
    ...
    console.log(`\nDone. Total Successfully sent: ${globalSuccessCount}. Total Failed: ${globalFailCount}`);
}
