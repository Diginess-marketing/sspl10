...
What would you like to know about SSPL? You can type or use the microphone.`,
  ...
  if (!isOpen) {
    return (
      <div className={`fixed top-36 md:top-24 right-6 z-[100001] ${className}`}>
        <button
          onClick={onToggle}
  ...
  return (
    <div className={`fixed top-48 md:top-40 right-6 z-[100001] ${className} animate-in fade-in slide-in-from-top-4 duration-300`}>
      <Card className={`w-96 ${isMinimized ? 'h-14' : 'max-h-[calc(100vh-200px)] h-[550px]'} shadow-2xl border-2 border-cricket-blue bg-white overflow-hidden flex flex-col transition-all duration-300`}>
        {/* Header */}
