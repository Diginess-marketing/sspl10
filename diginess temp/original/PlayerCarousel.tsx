  ...
  return (
    <div className="relative w-full py-12 overflow-hidden bg-[#050814] scroll-mt-24" id="auction-results">
      ...
      <div 
        ...
        style={{ backgroundImage: `url('/assets/carousel-bg.png')` }}
      />
      <div className="absolute inset-0 bg-gradient-to-b from-[#050814] via-black/40 to-[#050814] z-0" />
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#CCFF00]/10 rounded-full blur-[100px] z-0" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#00F0FF]/10 rounded-full blur-[100px] z-0" />
      
      <div className="w-[96%] max-w-[1536px] mx-auto px-4 sm:px-6 relative z-10">
