  ...
  return (
    <section className="py-12 md:py-16 relative overflow-hidden bg-[#0047AB]">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("/assets/partners-bg-texture.png")',
      ...
      />
      <div className="absolute top-[-10%] right-[-7%] w-[34%] h-[34%] rounded-full bg-[#00B4D8]/12 blur-[120px] pointer-events-none" />
