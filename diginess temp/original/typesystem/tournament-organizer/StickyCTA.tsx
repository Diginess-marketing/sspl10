...
const StickyCTA = () => {
    ...
    return (
        <div
            className={`fixed bottom-0 left-0 right-0 z-40 p-4 lg:p-6 lg:bottom-6 lg:left-auto lg:right-1/2 lg:translate-x-1/2 transition-transform duration-300 ease-in-out font-['Poppins',sans-serif] ${isVisible ? 'translate-y-0' : 'translate-y-[150%]'
                }`}
        >
