...
const Header = () => {
    ...
    return (
        <header
            className={`fixed top-0 left-0 right-0 z-50 transition-[background-color,padding,box-shadow] duration-500 font-['Poppins',sans-serif] ${isScrolled ? 'bg-white shadow-md py-3' : 'bg-transparent py-5'
                }`}
