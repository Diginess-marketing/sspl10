...
export default function DrillDownModal({ isOpen, onClose, title, players, loading, infoMessage }: DrillDownModalProps) {
    ...
    const handleDownloadPDF = () => {
        ...
        doc.setFontSize(14);
        doc.text(`${title} - Players List`, 14, 20);
        
        const tableColumn = ["Name", "Phone", "Email", "City", "State", "School", "Status", "Date"];
        const tableRows: any[] = [];
                    ...
                    <div className="bg-slate-900 text-white px-6 py-4 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="bg-red-600 hover:bg-red-700 text-white text-sm font-semibold py-1.5 px-4 rounded-lg flex items-center gap-2 transition duration-200"
                            >
                                📄 Download PDF
                            </button>
                            <button
