  ...
  <section className="hero-banner" aria-label="SSPL T10 introduction">
    <div className="hero-banner__stage">
      ...
      <div className="hero-banner__art" aria-hidden="true">
        <div className="hero-banner__canvas">
        <img className="hero-banner__bg" src={backgroundSrc} alt="" width={2164} height={727} {...{ fetchpriority: 'high' }} decoding="async" />
        <img className="hero-banner__script" src="/assets/hero/hero-script.png" alt="" width={1214} height={1295} decoding="async" />
        </div>
      </div>
      ...
      <div className="hero-banner__copy">
        ...
        <div className="hero-banner__title" aria-hidden="true">
          ...
          <img className="hero-banner__stage-title" src="/assets/hero/hero-stage-title.png" alt="" width={2172} height={724} decoding="async" />
        </div>
